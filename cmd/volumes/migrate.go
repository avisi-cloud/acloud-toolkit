...
func AddMigrateVolumeOptions(flagSet *flag.FlagSet, opts *migrateVolumeOptions) {
	...
	flagSet.Int64Var(&opts.newSize, "new-size", migratevolume.USE_EQUAL_SIZE, "Use a different size for the new PVC. Value is in MB. Default 0 means use same size as current PVC")
